...
import { ADD_COLLECTION_ROW, ADD_TAB, CLOSE_TAB, ADD_ROW, CHANGE_COLLECTION_DATA, CHANGE_DATA, CHANGE_FOLDER, DELETE_COLLECTION_ROW, DELETE_ROW, INSERT_COLLECTION_ROW, LOAD_CONFIG, REORDER_TABLE, SET_ACTIVE_ROW, SET_ACTIVE_TAB, REFETCH_TAB, SET_DRAWER_OPEN, LOAD_DATA, CHANGE_INDEX_DATA, SET_ERROR, CHANGE_KANBAN_STAGE } from './ActionTypes';
...
export const changeKanbanStage = (tabId, id, key, value) => {
  return (
    {
      type: CHANGE_KANBAN_STAGE,
      tabId, id, key, value
    }
  )
}
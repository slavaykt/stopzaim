        ...
        <Tab.Pane id="children" >
          <StyledOverflowDiv>
            <table className="table">
              <thead>
                <tr className="border-top-0 h-6">
                  <StyledTH rowSpan={2}>ФИО</StyledTH>
                  <StyledTH rowSpan={2}>Пол</StyledTH>
                  <StyledTH rowSpan={2}>Дата рождения</StyledTH>
                  <StyledTH colSpan={3}>Свидетельство о рождении</StyledTH>
                  <StyledTH ><FontAwesomeIcon icon={faTrashAlt} /></StyledTH>
                </tr>
                <tr>
                  <StyledTH>Серия</StyledTH>
                  <StyledTH>Номер</StyledTH>
                  <StyledTH>Дата выдачи</StyledTH>
                </tr>
              </thead>
              <tbody>
                {data.Дети.map((row, i) => {
                    ...
                    <tr key={i}>
                      <td className="p-1">
                        <StyledInputGroup w={300}>
                          <Form.Input className="border-0" name={`Дети.${i}.ФИО`} type="text" value={data.Дети[i].ФИО} onChange={collectionInputOnChange} />
                        </StyledInputGroup>
                      </td>
                      <td className="p-1">
                        <StyledInputGroup w={120}>
                          <Form.CustomSelect className="border-0" name={`Дети.${i}.Пол`} value={data.Дети[i].Пол} onChange={collectionInputOnChange}>
                            <option value="муж">муж</option>
                            <option value="жен">жен</option>
                          </Form.CustomSelect>
                        </StyledInputGroup>
                      ...
                      <td className="p-1">
                        <StyledInputGroup w={180}>
                          <Form.Input className="border-0" name={`Дети.${i}.ДатаРождения`} type="date" value={data.Дети[i].ДатаРождения} onChange={collectionInputOnChange} />
                        </StyledInputGroup>
                      </td>
                      <td className="p-1">
                        <StyledInputGroup w={120}>
                          <Form.Input className="border-0" name={`Дети.${i}.СвидетельствоСерия`} type="text" value={data.Дети[i].СвидетельствоСерия} onChange={collectionInputOnChange} />
                        </StyledInputGroup>
                      </td>
                      <td className="p-1">
                        <StyledInputGroup w={120}>
                          <Form.Input className="border-0" name={`Дети.${i}.СвидетельствоНомер`} type="text" value={data.Дети[i].СвидетельствоНомер} onChange={collectionInputOnChange} />
                        </StyledInputGroup>
                      </td>
                      <td className="p-1">
                        <StyledInputGroup w={180}>
                          <Form.Input className="border-0" name={`Дети.${i}.СвидетельствоДатаВыдачи`} type="date" value={data.Дети[i].СвидетельствоДатаВыдачи} onChange={collectionInputOnChange} />
                        </StyledInputGroup>
                      </td>
                      <TrashTD><FontAwesomeIcon icon={faTrashAlt} onClick={() => handleDeleteRow('Дети', i)} /></TrashTD>
                    </tr>)
                })}
                <StyledHiddenTR >
                  <td colSpan="6"><FontAwesomeIcon className="text-success" size="lg" icon={faPlusCircle} onClick={() => handleAddRow('Дети')} /> <hr style={{ display: 'inline' }} /> </td>
                </StyledHiddenTR>
              </tbody>
            </table>
          </StyledOverflowDiv>

...
class CreateCashIncomeOrdersTable extends Migration
{
  /**
   * Run the migrations.
   *
  ...
  public function up()
  {
    Schema::create('cash_income_orders', function (Blueprint $table) {
      $table->id();
      ...
      $table->string('ПринятоОт', 50)->default("");
  ...
  {
    Schema::dropIfExists('cash_income_orders');
  }
}
